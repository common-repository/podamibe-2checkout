...
//}
if ( !class_exists( 'Countries_List' ) ) {
    class Countries_List{
         ...
         * 
         * @param string $keyField - key field for the array of countries, set it to null if you want array without named indices
         * @param mixed $requestedFields - array of name of the fields to be fetched in value part of array
        ...
        /**
         * CountriesArray::getFromContinent()
         * 
         * @param string $keyField - key field for the array of countries, set it to null if you want array without named indices
         * @param string $requestedField - name of the field to be fetched in value part of array
         * @param mixed $continent - name of continent to use as filter
         * @returns array contained key=>value pairs of the requested key and field
